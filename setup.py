...
RESOLVER_NAME = 'sceptre-aws-vpc-resolver'
# the resolver call in sceptre e.g. !command_name.
RESOLVER_COMMAND_NAME = 'aws_vpc'
...
RESOLVER_CLASS = 'AwsVpc'
# One line summary description
RESOLVER_DESCRIPTION = 'A Sceptre resolver to retrieve VPC ID from AWS'
